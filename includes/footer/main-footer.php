                    ...
                    <div class="site-newsletter">
                        <div class="site-newsletter-text">
                            <h3 class="entry-title">
                                <?php echo machic_sanitize_data(get_theme_mod('machic_footer_subscribe_title')); ?></h3>
                            <div class="entry-description">
                                <p><?php echo machic_sanitize_data(get_theme_mod('machic_footer_subscribe_subtitle')); ?>
                                </p>
                ...
                <div class="col">
                    ...
                    <div class="site-details">
                        ...
                        <div class="site-social">
                            <ul>
                                ...
                                <li><a href="<?php echo esc_url($f['social_url']); ?>" target="_blank"><i
                                            class="klbth-icon-<?php echo esc_attr($f['social_icon']); ?>"></i></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                        <?php } ?>
                    ...
                    <div class="site-details">
                        <ul class="tags">
                            ...
                            <li><a href="<?php echo esc_url(get_term_link( $t )); ?>"><?php echo esc_html($t->name); ?>
                                </a></li>
                            <?php } ?>
                        </ul>
                    </div><!-- site-details -->
                    ...
                    <div class="footer-bottom">
                        ...
                        <div class="site-payment-logos">
                            <a href="<?php echo esc_url(get_theme_mod('machic_footer_payment_image_url')); ?>">
                                <img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod('machic_footer_payment_image'))); ?>"
                                    alt="<?php esc_attr_e('payment','machic'); ?>">
                            </a>
                        </div>
                        <?php } ?>
                    </div><!-- footer-bottom -->
